...
#How to run:
#python get_sfs_from_full_output_general_reps.py -input_folder /path/to/intput/folder -output_folder /path/to/output -output_prefix /name/of/output/file -mutn_types m1,m2,m3 -num_indv 100
import sys
import argparse
import os
...
parser.add_argument('-input_folder', dest = 'input_folder', action='store', nargs = 1, type = str, help = '/home/user/Desktop/syn_proyect_ trial1/Input_slim_1')
parser.add_argument('-output_folder', dest = 'output_folder', action='store', nargs = 1, type = str, help = '/Output_slim_1/.')
parser.add_argument('-output_prefix', dest = 'output_prefix', action='store', nargs = 1, type = str, help = 'trial_2_syn_output_py.txt')
parser.add_argument('-mutn_types', dest = 'mutn_types', action='store', nargs = 1, default="m5", type = str, help = 'm1,m2,m3,m4,m5')
parser.add_argument('-num_indv', dest = 'num_indv', action='store', nargs = 1, default=100, type = int, help = '1000')
